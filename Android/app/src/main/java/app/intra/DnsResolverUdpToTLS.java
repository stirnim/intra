...
// Reads DNS requests over UDP from |tunFd|, forwards them over a TLS connection
...
public class DnsResolverUdpToTLS extends Thread {
   ...
   */
  private class DnsOverTLSResponseCallback implements DOTCallback {
     ...
     */
    public DnsOverTLSResponseCallback(DnsMetadata request, FileOutputStream output) {
      dnsMetadata = request;
      outputStream = output;
    ...
    public void onDOTAnswer(byte[] dnsResponse) {
